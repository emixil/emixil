...
This mechanism has been integrated into Bitcore-Node-Emixil which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/emixil/insight-api-emixil#web-socket-api](https://github.com/emixil/insight-api-emixil#web-socket-api) 
* API: [https://github.com/emixil/insight-api-emixil#instantsend-transactions](https://github.com/emixil/insight-api-emixil#instantsend-transactions) 
...
By default, the Emixil Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Emixil Core daemon:
