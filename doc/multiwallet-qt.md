...
Only requiring some minor changes is emixil.cpp.
...
Changes to emixil.cpp
----------------------
emixil.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
