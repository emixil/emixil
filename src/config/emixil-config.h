/* src/config/emixil-config.h.  Generated from emixil-config.h.in by configure.  */
/* src/config/emixil-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Emixil Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Emixil Core"
...
#define PACKAGE_BUGREPORT "https://github.com/emixil/emixil/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Emixil Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Emixil Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "emixil"
