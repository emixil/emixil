...
{
    if(fLiteMode) return; // ignore all Emixil related functionality
...
/*
    ...
    allow endless transaction that would bloat Emixil and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("emixil-privatesend");
