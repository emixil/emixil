 ...
 *
 *   // network
 *   CEmixilNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.emixil.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEmixilNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EmixilNetwork
// //   -- signature requirements : Key1(User)
// class CEmixilNetworkVariable : public CGovernanceObject
// {
// private:
