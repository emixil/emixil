...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EmixilNetwork") type = EmixilNetwork;
    if(strType == "EmixilNetworkVariable") type = EmixilNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EmixilNetwork) s = "EmixilNetwork";
    if(type == EmixilNetworkVariable) s = "EmixilNetworkVariable";
