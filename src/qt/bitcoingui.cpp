    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Emixil Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Emixil address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and emixil: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Emixil Core"), this);
    aboutAction->setStatusTip(tr("Show information about Emixil Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Emixil Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Emixil addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Emixil addresses"));
    ...
    openAction->setStatusTip(tr("Open a emixil: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Emixil Core help message to get a list with possible Emixil Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Emixil Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Emixil network", "", count));
}
...
{
    QString strTitle = tr("Emixil Core"); // default title
