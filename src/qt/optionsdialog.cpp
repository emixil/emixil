    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EXL-light"), QVariant("light"));
    ui->theme->addItem(QString("EXL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EXL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EXL-traditional"), QVariant("trad"));
