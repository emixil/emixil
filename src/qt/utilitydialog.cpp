    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Emixil Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Emixil Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  emixil-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Emixil in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an emixiltive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 EXL, 0.1 EXL, 1 EXL and 10 EXL -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Emixil Core is shutting down...") + "<br /><br />" +
