...
2. run emixild with -printalert or -sendalert like this:
   /path/to/emixild -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://emixil.pw";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Emixil Core:0.12.0.58/"));
